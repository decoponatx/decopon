      ...
      <div className='content'>
        ...
        <div id='iStep2'>
          ...
          <p className='content'>
            ...
            <br></br><br></br>
            Finally, take a moment to peek into your kit. Make sure you have your decoden item, cream, additional tips, charming charms, and a postcard. Each cream bag is ready to go with a piping tip already attached, so you're all set to start your creative journey!
          </p>
        </div>
        <div id='iStep3'>
